...
import kr.or.hsnarae.transporthelp.common.FCM.PushKeyTokenEvent;
...
import kr.or.hsnarae.transporthelp.impl.net.json.JSONUpdateMessageEvent;
...
import kr.or.hsnarae.transporthelp.impl.net.json.rep.REP_JSONHandDegreeList;
import kr.or.hsnarae.transporthelp.impl.net.json.rep.REP_JSONHandTypeList;
import kr.or.hsnarae.transporthelp.impl.net.json.rep.REP_JSONIntro;
import kr.or.hsnarae.transporthelp.impl.net.json.rep.REP_JSONUPdateCheck;
...
import kr.or.hsnarae.transporthelp.impl.net.json.req.JSON_REQHandDegreeList;
import kr.or.hsnarae.transporthelp.impl.net.json.req.JSON_REQHandTypeList;
import kr.or.hsnarae.transporthelp.impl.net.json.req.JSON_REQIntro;
import kr.or.hsnarae.transporthelp.impl.net.json.req.JSON_REQUpdateCheck;
...
public class IntroActivity extends Activity
{
    ...
    private final int MSG_UPDATE_VIEW = 17;
    private final int MSG_UPDATECHECK_CANCEL = 18;

    private final int MSG_HANDI_TYPE = 20;
    private final int MSG_HANDI_DEGREE = 21;
    private final int MSG_USE_TYPE = 22;
    private final int MSG_SUCCESS_INITDATE = 23;
    ...
    {
        ((HSNaraeApplication)getApplication()).initializeDB();
                ...
                public void run() {
                    ...
                    if (list != null && list.size() > 0)
                    {
                        ...
                        try{
                            ...
                            {
                                sql = String.format("INSERT INTO %s (name, code) VALUES ('%s', '%s');" ,DBSchema.TABLE_NAME_USETYPE
