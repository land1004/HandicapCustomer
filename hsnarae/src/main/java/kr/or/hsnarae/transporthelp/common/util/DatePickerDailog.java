...
import kr.or.hsnarae.transporthelp.common.util.wheel.ArrayWheelAdapter;
import kr.or.hsnarae.transporthelp.common.util.wheel.NumericWheelAdapter;
import kr.or.hsnarae.transporthelp.common.util.wheel.OnWheelChangedListener;
import kr.or.hsnarae.transporthelp.common.util.wheel.WheelView;

public class DatePickerDailog extends Dialog {

	private Context Mcontex;

	private int NoOfYear = 150;
	...
	public DatePickerDailog(Context context, Calendar calendar,
		...
		String months[] = new String[] { "1 월", "2 월", "3 월",
				"4 월", "5 월", "6 월", "7 월", "8 월", "9 월",
				"10 월", "11 월", "12 월" };
