...
import kr.or.hsnarae.transporthelp.impl.net.json.req.ReqMultiPartService;
import kr.or.hsnarae.transporthelp.impl.net.json.req.ReqService;
import kr.or.hsnarae.transporthelp.impl.net.json.req.ReqUpdateCheckService;
...
public class RetrofitProcessManager
{
    ...
    public static synchronized void doRetrofitMultiPartRequestService(final Context context, String pageName, String req, String filepath)
    {
        ...
        RequestBody query =
                RequestBody.create(
                        okhttp3.MultipartBody.FORM, req);
    ...
    // 운영 서버
    private static final String URL_UPLOAD_IMAGE = "http://ctmappitf.hsnarae.or.kr:38080/CTMAppITF/passenger/RegMember";
