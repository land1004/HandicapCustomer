...
public class JSON_REQCallHistory extends JSON_REQHeader
{
    private final String THIS_TAG = "JSON_REQCallHistory";

    public static final String PAGE_NAME= "CallHistory";
    public static final String PROTOCOL_VERSION = "1.1";

    private JsonObject m_body = null;

    public JSON_REQCallHistory(String authkey)
    {
