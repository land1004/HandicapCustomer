...
public class JSON_REQHandDegreeList extends JSON_REQHeader
{
    private final String THIS_TAG = "JSON_REQHandDegreeList";

    public static final String PAGE_NAME= "HandiDegreeList";
    public static final String PROTOCOL_VERSION = "1";

    private JsonObject m_body = null;

    public JSON_REQHandDegreeList()
    {
