...
public class JSON_REQMemberInfo extends JSON_REQHeader
{
    private final String THIS_TAG = "JSON_REQMemberInfo";

    public static final String PAGE_NAME= "MemberInfo";
    public static final String PROTOCOL_VERSION = "1";

    private JsonObject m_body = null;

    public JSON_REQMemberInfo(String authkey, String pushkey)
    {
