...
public class dbHelper extends SQLiteOpenHelper
{
	...
	private static final int DATABASE_VERSION =1;		// 테이블 정보가 수정되면 버전을 조정한다.
...
//             													.getAbsolutePath() + File.separator +"customer/";
	private static final String FILE_PATH = Util.getWorkingFolder("yongin");
	...
	public void onCreate(SQLiteDatabase db) 
	{
		...
		if (DATAVASE_NAME.equals(DBSchema.DB_NAME))
		{
			...
			// 접수가능 지역 (경기도)
			db.execSQL(DBSchema.TABLE_CREATE_AVAILABLE_DESTINATION);
