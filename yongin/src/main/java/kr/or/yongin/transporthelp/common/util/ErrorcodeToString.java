...
public class ErrorcodeToString
{
    ...
    public static void setErrorCode ()
    {
        ...
        mErrorCode.put("F1007", "회원가입 승인이 거부된 번호입니다. 자세한 사항은 센터에 문의하세요.");
        ...
        mErrorCode.put("F1026", "기존에 예약접수된 내역이 있습니다. 접수된 배차 이용 완료 후, 다시 예약접수하여 주시기 바랍니다.");
        mErrorCode.put("F1027", "기존에 예약접수된 내역이 있습니다. 예약 내역이 있는 경우에는 치료 목적으로만 즉시배차 이용이 가능합니다.");
