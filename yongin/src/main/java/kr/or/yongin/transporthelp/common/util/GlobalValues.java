...
{
    public static String SERVICE_CODE = "HTYICA";    // 용인교통약자 서비스 코드
    ...
    // Main service start
    public static String ACTION_MAIN_SERVICE = "kr.or.yongin.transporthelp.service.MAINSERVICEPROCESS";

    // Broadcast receiver
    public static String ACTION_BROADCAST_SERVER= "kr.or.yongin.transporthelp.service.BROADCAST";
    public static String ACTION_BROADCAST_PUSH= "kr.or.yongin.transporthelp.service.PUSH";
}
