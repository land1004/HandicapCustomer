...
public class JSON_REQAvailableDestination extends JSON_REQHeader
{
    private final String THIS_TAG = "JSON_REQAvailableDestination";

    public static final String PAGE_NAME= "AvailableDestination";
    public static final String PROTOCOL_VERSION = "1";

    private JsonObject m_body = null;

    public JSON_REQAvailableDestination()
    {
