...
public class JSON_REQReqCallCancel extends JSON_REQHeader
{
    private final String THIS_TAG = "JSON_REQReqCallCancel";

    public static final String PAGE_NAME= "ReqCallCancel";
    public static final String PROTOCOL_VERSION = "1";

    private JsonObject m_body = null;

    public JSON_REQReqCallCancel(String authkey, String callid)
    {
