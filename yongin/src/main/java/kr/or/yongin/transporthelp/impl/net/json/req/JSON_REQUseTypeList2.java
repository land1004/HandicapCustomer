...
public class JSON_REQUseTypeList2 extends JSON_REQHeader
{
    private final String THIS_TAG = "JSON_REQUseTypeList";

    public static final String PAGE_NAME= "UseTypeAvailTimeList";
    public static final String PROTOCOL_VERSION = "1";

    private JsonObject m_body = null;

    public JSON_REQUseTypeList2()
    {
