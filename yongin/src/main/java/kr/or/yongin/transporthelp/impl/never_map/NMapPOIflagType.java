...
public class NMapPOIflagType 
{
	...
	public static final int PIN = SINGLE_POI_BASE + 2;
	public static final int STATION = SINGLE_POI_BASE + 3;
	public static final int GET_ON = SINGLE_POI_BASE + 4;
	public static final int GET_OFF = SINGLE_POI_BASE + 5;
	public static final int CAR = SINGLE_POI_BASE + 5;

	// Panorama icons
	public static final int PANORAMA = SINGLE_POI_BASE + 100;
