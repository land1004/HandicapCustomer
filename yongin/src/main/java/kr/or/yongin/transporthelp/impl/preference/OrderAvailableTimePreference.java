...
public class OrderAvailableTimePreference extends BaseSharedPreference
{
    ...
    private final String ORDERABAILABLE_PREFERENCE = "kr.or.yongin.transporthelp.preference.orderavailabletime";

    public static final String ORDERABAILABLE_STARTDATE = "kr.or.yongin.transporthelp.preference.orderavailabletime.startdate";
    public static final String ORDERABAILABLE_STARTTIME = "kr.or.yongin.transporthelp.preference.orderavailabletime.starttime";
    public static final String ORDERABAILABLE_ENDDATE = "kr.or.yongin.transporthelp.preference.orderavailabletime.enddate";
    public static final String ORDERABAILABLE_ENDTIME = "kr.or.yongin.transporthelp.preference.orderavailabletime.endtime";

    public static final String ORDERABAILABLE_RESERVECD_STARTDATE = "kr.or.yongin.transporthelp.preference.orderavailabletime.reserved_startdate";
    public static final String ORDERABAILABLE_RESERVECD_STARTTIME = "kr.or.yongin.transporthelp.preference.orderavailabletime.reserved_starttime";
    public static final String ORDERABAILABLE_RESERVECD_ENDDATE = "kr.or.yongin.transporthelp.preference.orderavailabletime.reserved_enddate";
    public static final String ORDERABAILABLE_RESERVECD_ENDTIME = "kr.or.yongin.transporthelp.preference.orderavailabletime.reserved_endtime";
