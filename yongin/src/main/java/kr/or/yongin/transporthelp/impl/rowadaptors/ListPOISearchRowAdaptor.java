...
public class ListPOISearchRowAdaptor extends ArrayAdapter<HashMap<String, String>>
{
	...
	public ListPOISearchRowAdaptor(Context context, int textViewResourceId, ArrayList<HashMap<String, String>> objects)
	{
